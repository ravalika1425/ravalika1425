...
import { faCheckCircle, faCheckDouble, faCircleInfo, faClock, faDirections, faDumbbell, faEnvelope, faEye, faInfo, faInfoCircle, faLayerGroup, faLocation, faLocationPin, faMapLocation, faMoneyBillWave, faMoneyCheck, faPhone, faTableTennis, faTimesCircle, faUser, faUserAlt, faUserCheck, faUserFriends, faVoicemail } from '@fortawesome/free-solid-svg-icons';
